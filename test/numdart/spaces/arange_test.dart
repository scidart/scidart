...
void main() {
  test('create an array range with 3 elements', () {
  ...
  test('create an array range with 4 elements', () {
  ...
  test('create an array range with 2 elements', () {
  ...
  test('create an array range with 1 elements', () {
